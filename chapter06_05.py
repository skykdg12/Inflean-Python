...
# 2가지 패턴 실습
# concurrenct.futures map
# concurrenct.futures wait, as_completed
...
def main():
    ...
    with ThreadPoolExecutor() as excutor:
        ...
        # # 실패
        # print('Pending ones after waiting for 5seconds : ' + str(result.not_done))
        # # 결과 값 출력
        # print([futures.result() for futures in result.done])
